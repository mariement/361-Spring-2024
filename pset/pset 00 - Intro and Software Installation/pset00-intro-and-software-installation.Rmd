...
![](img/snip of Course Survey anran.png)
...
These packages are successfully loaded on my computer.
...
g = ggplot(iris, 
            aes(x = Petal.Width, 
                y = Petal.Length)) + 
  geom_point() + 
  ggtitle("Anran Jiao's animation")
g
...
![](img/snip of animation anran.png)
...
I have added all the bookmarks to my browser.
...
![](img/snip of GitHub Desktop anran.png)
...
![](img/snip%20of%20GitHub%20Copilot%20anran.png)
